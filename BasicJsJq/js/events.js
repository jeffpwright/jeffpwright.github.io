...
{
	document.getElementById("checkEmployee").addEventListener('click', alert("Hello checkEmployee"), false);
	document.getElementById("checkRegistered").addEventListener('click', alert("Hello checkRegistered"), false);
